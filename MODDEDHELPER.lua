...
local var_0_18_wallbang = {
	[var_0_1.weapon_revolver] = true,
	[var_0_1.weapon_awp] = true,
	[var_0_1.weapon_ssg08] = true,
	[var_0_1.weapon_g3sg1] = true,
	[var_0_1.weapon_scar20] = true
}
...
local var_0_105 = {
	__index = {
		...
		get_export_tbl = function(arg_50_0)
			...
			if arg_50_0.fakeduck then
				var_50_0.fakeduck = true
			end
...
local function var_0_106(arg_53_0)
	...
	if arg_53_0.fakeduck == nil or type(arg_53_0.fakeduck) == "boolean" then
		var_53_0.fakeduck = arg_53_0.fakeduck == true
	else
		return string.format("invalid fakeduck value (%s)", tostring(arg_53_0.fakeduck))
	end
	...
	local var_53_16
	local var_53_17
	local var_53_18_wallbang

	for iter_53_2 = 1, #var_53_0.weapons do
		if var_53_0.weapons[iter_53_2].type == "grenade" then
			var_53_16 = true
		elseif var_0_18_wallbang[var_53_0.weapons[iter_53_2]] then
			var_53_18_wallbang = true
		else
			var_53_17 = true
		end
	end
	...
	if var_53_16 and var_53_18_wallbang then
		return "can't have grenade and wallbang weapon in one location"
	end
	
	if var_53_17 and var_53_18_wallbang then
		return "can't mix wallbang and non-wallbang weapons"
	end
	...
	elseif var_53_18_wallbang then
...
local function var_0_111(arg_58_0, arg_58_1)
	arg_58_1("Remote sources are disabled")
	return
	var_0_0.get(arg_58_0, {
		network_timeout = 5,
		absolute_timeout = 10,
		params = {
			ts = var_0_77()
		...
		get_locations = function(arg_64_0, arg_64_1, arg_64_2)
			...
			if var_0_98[arg_64_0][arg_64_1] == nil then
				...
				elseif var_64_0 == nil and arg_64_2 and arg_64_0.type == "remote" and arg_64_0.url_format ~= nil then
					arg_64_0.remote_status = "Remote sources are disabled"
					var_0_99()
...
var_0_113 = ui.new_string("Helper: config", "{}")
...
local var_0_135_fakeduck = ui.reference("RAGE", "Other", "Duck peek assist")
...
local var_0_144_hidedup = ui.new_checkbox("VISUALS", "Other ESP", "Hide duplicates")
local var_0_144_fakeduck_mode = ui.new_combobox("VISUALS", "Other ESP", "Fakeduck return mode", {"Always on", "On hotkey", "Toggle", "Off hotkey"})
local var_0_144 = {
...
function var_0_148()
	if not var_0_153 and var_0_154 ~= nil then
		...
		if bit.band(entity.get_prop(var_119_1, "m_fFlags"), var_0_37) == var_0_37 or entity.get_prop(var_119_1, "m_MoveType") == var_0_38 then
			...
			if ui.get(var_0_135_fakeduck) then
...
local function var_0_189(arg_127_0, arg_127_1)
		...
		if var_127_2.enabled[var_127_4.id] then
			...
			for iter_127_2 = 1, #var_127_5 do
				...
				if var_127_9.type == "grenade" then
					if var_127_9.tickrates[var_127_0] ~= nil and var_127_9.weapons_assoc[arg_127_1] then
				...
				elseif var_127_9.type == "wallbang" then
					if var_127_3.Wallbang and var_127_9.weapons_assoc[arg_127_1] then
						var_127_10 = true
					end
				else
	...
	local var_127_hidedup = ui.get(var_0_144_hidedup) and not var_0_164
	
	for iter_127_10, iter_127_11 in pairs(var_0_102) do
		if var_127_hidedup then
			local var_127_seen = {}
...
local var_0_194 = {}
local var_0_195 = {}
local var_0_195_fdactive = false
...
local function var_0_196(arg_130_0)
	...
	if var_0_195_fdactive then
		local var_fd_returned = ui.get(var_0_144_fakeduck_mode)
		ui.set(var_0_135_fakeduck, var_fd_returned)
		var_0_195_fdactive = false
	end
...
local function var_0_202_wallbang(arg_136_wb_0, arg_136_wb_1, arg_136_wb_2)
	local var_136_wb_0 = ui.get(var_0_140)
	
	if var_136_wb_0 == "Rage" or var_136_wb_0 == "Legit (Silent)" then
		arg_136_wb_0.pitch = var_0_185.viewangles.pitch
		arg_136_wb_0.yaw = var_0_185.viewangles.yaw
		
		if var_136_wb_0 == "Rage" or var_136_wb_0 == "Legit (Silent)" then
			arg_136_wb_0.allow_send_packet = false
		end
	else
		client.camera_angles(var_0_185.viewangles.pitch, var_0_185.viewangles.yaw)
	end
...
local function var_0_203(arg_137_0, arg_137_1, arg_137_2)
	...
	elseif var_0_185.type == "wallbang" then
		var_0_202_wallbang(arg_137_0, arg_137_1, arg_137_2)
	end
end
...
local function var_0_205(arg_139_0)
	...
	elseif var_0_184 ~= nil and var_139_3 and var_0_184.is_in_fov and var_0_184.is_position_correct then
		...
		if var_0_184.fakeduck and var_139_3 then
			if not var_0_195_fdactive then
				ui.set(var_0_135_fakeduck, "Always on")
				var_0_195_fdactive = true
			end
		elseif var_0_195_fdactive and (not var_139_3 or not var_0_184.fakeduck) then
			local var_fd_returned = ui.get(var_0_144_fakeduck_mode)
			ui.set(var_0_135_fakeduck, var_fd_returned)
			var_0_195_fdactive = false
		end
	...
	elseif var_0_183 ~= nil and var_139_3 then
		...
		if var_0_184 ~= nil and var_0_184.fakeduck and var_139_13 < 10 and var_139_3 then
			if not var_0_195_fdactive then
				ui.set(var_0_135_fakeduck, "Always on")
				var_0_195_fdactive = true
			end
		elseif var_0_195_fdactive and (not var_139_3 or not var_0_184 or not var_0_184.fakeduck or var_139_13 >= 10) then
			local var_fd_returned = ui.get(var_0_144_fakeduck_mode)
			ui.set(var_0_135_fakeduck, var_fd_returned)
			var_0_195_fdactive = false
		end
...
local function var_0_207()
	...
	ui.set_visible(var_0_144_hidedup, var_141_0)
	ui.set_visible(var_0_144_fakeduck_mode, var_141_0)
...
ui.set_callback(var_0_144_hidedup, function()
	var_0_103("hide_duplicates changed")
end)
var_0_207()
